          ...
          <div class="row col col-md-6">
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                <label class="font-weight-bold" for="ad_con_mode">Admin Control Mode :</label>
                <input id="ad_con_mode" type="text" class="form-control" value="<?php echo $ad_con_mode; ?>" placeholder="Current Admin Mode" onkeyup="validateName(this.value, 'admin_name_error');" disabled>
                <code class="text-danger small font-weight-bold float-right mb-2" id="admin_name_error" style="display: none;"></code>
              </div>
            </div>
            ...
            <!-- form submit button -->
            <div class="row col col-md-3 m-auto" ></div>
            <div class="row col col-md-6 m-auto" id="edit">
              ...
              <div id="password_button" class="col col-md-10 form-group float-right">
