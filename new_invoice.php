    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('clipboard', 'New Buyout', 'Create New Buyout');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-2 form-group">
              ...
              <input id="invoice_number" type="text" class="form-control"  placeholder="Invoice Number" disabled>
            </div>
            <div class="col col-md-2 form-group">
